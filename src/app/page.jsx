...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col relative">
      ...
      {/* Botão Flutuante Elegante - Voltar ao Topo */}
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            initial={{ opacity: 0, y: 20 }}
            ...
            exit={{ opacity: 0, y: 20 }}
            onClick={scrollToTop}
            className="fixed bottom-8 right-8 z-50 bg-black text-white w-12 h-12 flex items-center justify-center shadow-2xl hover:bg-gray-800 transition-colors duration-300"
          >
