...
// Reutilizando a sua Engrenagem de Alta Performance
...
export default function Viabilidade() {
  ...
  return (
    <main className="min-h-screen flex flex-col relative bg-white selection:bg-black selection:text-white">
      ...
      {/* NAVEGAÇÃO SUPERIOR (Ajustada para a página interna) */}
      <motion.nav 
      ...
      >
        <Link href="/">
          <motion.div 
            ...
            className="relative w-48 h-8 md:h-10 cursor-pointer transition-opacity"
          >
            {/* Como o fundo aqui será claro, ideal usar a logo escura caso tenha. Se não, o CSS filter inverte a branca */}
            <Image 
        ...
        <div className="space-x-8 text-sm uppercase tracking-wide hidden md:flex items-center text-black font-medium">
          ...
          <a href="https://app.stangherlin.arq.br" target="_blank" rel="noopener noreferrer" className="border border-black text-black px-6 py-2 hover:bg-black hover:text-white transition">
            Acessar App
          </a>
        </div>
      </motion.nav>

      {/* SECTION 1: HERO (O Gancho) */}
      <section className="relative pt-40 pb-20 lg:pt-56 lg:pb-32 px-6 lg:px-12 flex flex-col items-center text-center">
        <motion.div 
          ...
          className="max-w-5xl"
        >
          <h2 className="text-xs uppercase tracking-[0.3em] text-gray-400 mb-6">Inteligência Construtiva</h2>
          ...
          <p className="text-lg md:text-2xl text-gray-500 max-w-3xl mx-auto mb-12 font-light leading-relaxed">
            Substitua suposições por dados matemáticos. Nosso simulador paramétrico calcula recuos, avanços e a viabilidade preliminar para você negociar aquisições e permutas com total segurança e transparência.
          </p>
          <a 
            href="https://app.stangherlin.arq.br" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-black text-white px-10 py-5 uppercase tracking-widest text-sm hover:bg-gray-800 transition duration-300"
          >
      ...
      {/* SECTION 2: A Dor do Mercado (Usando FluidReveal) */}
          ...
          <div className="lg:w-1/2">
            <h3 className="text-3xl md:text-5xl font-light leading-snug text-gray-900">
              ...
              <FluidReveal delay={0.4}>
                <span className="font-medium">incorporação é o tempo.</span>
              </FluidReveal>
            </h3>
          </div>
          <div className="lg:w-1/2">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 1 }}>
              <h4 className="text-sm uppercase tracking-[0.2em] text-gray-400 mb-4 border-b border-gray-200 pb-4">A Bússola Paramétrica</h4>
              <p className="text-gray-900 text-xl font-light leading-relaxed mb-6">
                Nosso cérebro matemático faz o trabalho pesado em instantes.
              </p>
      ...
      <section className="bg-gray-900 text-white py-24 px-6 lg:px-12 text-center">
        ...
        >
          <h2 className="text-3xl lg:text-5xl font-light mb-10 leading-tight">
            Pare de adivinhar. <br /><span className="font-medium">Comece a calcular.</span>
          </h2>
          <a 
            href="https://app.stangherlin.arq.br" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-white text-black px-12 py-5 uppercase tracking-widest text-sm font-bold shadow-lg hover:scale-105 transition-transform"
          >
      ...
      {/* SCROLL TO TOP (Igual ao do site principal) */}
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            initial={{ opacity: 0, y: 20 }}
